...
X_buffer  = [[p0; x0], [p0; x0], [p0; x0]];
ctrl_last_buffer = cell(1,3);
ctrl_buffer      = cell(1,3);

for i = 1:N
    ctrl_last_buffer = ctrl_buffer;
    for controller_idx = 1:3
        X = X_buffer(:, controller_idx);
        ctrl_last = ctrl_last_buffer{controller_idx};
        ...
        X_buffer(:, controller_idx) = X;
        ctrl_buffer{controller_idx} = ctrl;
    end
end
